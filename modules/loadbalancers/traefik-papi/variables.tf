variable "name" {
  description = "Name of the traefik-papi cluster (for ex. traefik-papi)"
...
variable "instance_type" {
  description = "EC2 type for traefik-papi instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the traefik-papi cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the traefik-papi instances"
  default     = ""
}
