variable "name" {
  description = "Name of the traefik-service cluster (for ex. traefik-service)"
  default     = "traefik-service"
}
...
variable "instance_type" {
  description = "EC2 type for traefik-service instances"
  default     = "m4.large"
}
...
variable "number_of_instances" {
  description = "Number of instances in the traefik-service cluster"
  default     = "1"
}
...
variable "region" {
  description = "AWS region where to create the traefik-service instances"
  default     = ""
}
