Traefik Non SSL Terraform module
========================

Terraform module which creates AWS Ec2 machines and install Traefik.

These types of resources are supported:

```
module "traefik-service" {
  source                     = "../../../../modules/services/traefik-service/"
  key_name                   = "${var.env}-${var.region}"
  security_groups            = ["${data.terraform_remote_state.vpc.traefik_sg_id}"]
  org                        = "${var.org}"
  region                     = "${var.region}"
  fullaz                     = "${var.region}b"
  env                        = "${var.env}"
