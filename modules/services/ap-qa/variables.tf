variable "name" {
  description = "Name of the ap-qa cluster (for ex. ap-qa)"
  default     = "ap-qa"
}
...
variable "instance_type" {
  description = "EC2 type for ap-qa instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the ap-qa cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the ap-qa instances"
  default     = ""
}
