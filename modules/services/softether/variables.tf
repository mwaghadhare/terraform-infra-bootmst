variable "name" {
  description = "Name of the softether cluster (for ex. softether)"
  default     = "softether"
}
...
variable "instance_type" {
  description = "EC2 type for softether instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the softether cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the softether instances"
  default     = ""
}
