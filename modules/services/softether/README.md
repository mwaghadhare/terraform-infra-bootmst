Softether Terraform module
========================

Terraform module which creates AWS Ec2 machines and install Softether.
...
```
module "softether" {
  source                     = "../../../../modules/services/softether/"
  key_name                   = "${var.env}-${var.region}"
  security_groups            = ["${data.terraform_remote_state.vpc.softether_sg_id}"]
  org                        = "${var.org}"
  region                     = "${var.region}"
  fullaz                     = "${var.region}b"
  env                        = "${var.env}"
