Monitor Terraform module
========================

Terraform module which creates AWS Ec2 machines and install Riemann.
...
module "monitor" {
  ...
  security_groups            = ["${data.terraform_remote_state.vpc.monitor_sg_id}"]
  org                        = "${var.org}"
  region                     = "${var.region}"
  fullaz                     = "${var.region}b"
  env                        = "${var.env}"
