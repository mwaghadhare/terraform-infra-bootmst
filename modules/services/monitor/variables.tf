variable "name" {
  description = "Name of the monitor cluster (for ex. monitor)"
  default     = "monitor"
}
...
variable "instance_type" {
  description = "EC2 type for monitor instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the monitor cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the monitor instances"
  default     = ""
}
