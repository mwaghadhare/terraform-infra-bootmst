variable "name" {
  description = "Name of the zookeeper-misc cluster (for ex. zookeeper-misc)"
  default     = "zookeeper-misc"
}

variable "role_name" {
  description = "Name of the zookeeper-misc role (for ex. zookeeper_misc_env)"
  default     = "zookeeper-misc"
}
...
variable "instance_type" {
  description = "EC2 type for zookeeper-misc instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the zookeeper-misc cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the zookeeper-misc instances"
  default     = ""
}
