variable "name" {
  description = "Name of the chef-server cluster (for ex. chef-server)"
  default     = "chef-server"
}
...
variable "instance_type" {
  description = "EC2 type for chef-server instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the chef-server cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the chef-server instances"
  default     = ""
}
...
# Commenting as we will use i3 instance types and NVME disk
