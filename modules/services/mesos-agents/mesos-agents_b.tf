...
resource "aws_spot_fleet_request" "mesos-agents_b" {
  ...
  launch_specification {
    ...
    user_data              = "${data.template_file.userdata_b.rendered}"
