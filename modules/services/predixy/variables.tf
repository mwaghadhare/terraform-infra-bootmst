variable "name" {
  description = "Name of the predixy cluster (for ex. predixy)"
  default     = "predixy"
}
...
variable "instance_type" {
  description = "EC2 type for predixy instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the predixy cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the predixy instances"
  default     = ""
}
