variable "name" {
  description = "Name of the elasticsearch cluster (for ex. elasticsearch)"
  default     = "es-data"
}
...
variable "instance_type" {
  description = "EC2 type for elasticsearch instances"
  default     = "t2.medium"
}
...
variable "region" {
  description = "AWS region where to create the elasticsearch instances"
  default     = ""
}
