variable "name" {
  description = "Name of the graphite cluster (for ex. graphite)"
  default     = "graphite"
}
...
variable "instance_type" {
  description = "EC2 type for graphite instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the graphite cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the graphite instances"
  default     = ""
}
