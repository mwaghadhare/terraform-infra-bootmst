Graphite Terraform module
========================

Terraform module which creates AWS Ec2 machines and install Graphite and Grafana.
...
```
module "graphite" {
  source                     = "../../../../modules/services/graphite/"
  key_name                   = "${var.env}-${var.region}"
  security_groups            = ["${data.terraform_remote_state.vpc.graphite_sg_id}"]
  org                        = "${var.org}"
  region                     = "${var.region}"
  fullaz                     = "${var.region}b"
  env                        = "${var.env}"
