variable "name" {
  description = "Name of the storm-supervisors cluster (for ex. storm-supervisors)"
  default     = "storm-supervisors"
}
...
variable "instance_type" {
  description = "EC2 type for storm-supervisors instances"
  default     = ""
}
...
variable "number_of_instances" {
  description = "Number of instances in the storm-supervisors cluster"
  default     = 3
}
...
variable "region" {
  description = "AWS region where to create the storm-supervisors instances"
  default     = ""
}
