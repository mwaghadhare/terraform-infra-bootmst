variable "name" {
  description = "Name of the consul cluster (for ex. consul)"
  default     = "consul"
}
...
variable "instance_type" {
  description = "EC2 type for consul instances"
  default     = ""
}
...
variable "number_of_instances" {
  description = "Number of instances in the consul cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the consul instances"
  default     = ""
}
