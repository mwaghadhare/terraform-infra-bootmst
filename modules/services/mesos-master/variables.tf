variable "name" {
  description = "Name of the mesos-master cluster (for ex. mesos-master)"
...
variable "instance_type" {
  description = "EC2 type for mesos-master instances"
  default     = ""
}
...
variable "number_of_instances" {
  description = "Number of instances in the mesos-master cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the mesos-master instances"
  default     = ""
}
...
variable "role_name" {
  description = "Name of the consul role"
  default     = ""
}
