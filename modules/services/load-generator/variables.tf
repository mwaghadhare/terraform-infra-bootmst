variable "name" {
  description = "Name of the load-generator cluster (for ex. load-generator)"
...
variable "instance_type" {
  description = "EC2 type for load-generator instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the load-generator cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the load-generator instances"
  default     = ""
}
