variable "name" {
  description = "Name of the influxdb cluster (for ex. influxdb)"
  default     = "influxdb"
}
...
variable "instance_type" {
  description = "EC2 type for influxdb instances"
  default     = "t2.medium"
}
...
variable "number_of_instances" {
  description = "Number of instances in the influxdb cluster"
  default     = ""
}
...
variable "region" {
  description = "AWS region where to create the influxdb instances"
  default     = ""
}
